...
VSCODE_UI_COLORS = OrderedDict([
    ...
    ("statusBar.noFolderForeground", "@pure_white"),
    ("statusBarItem.remoteBackground", "#16825d"),
    ("statusBarItem.remoteForeground", "@pure_white"),
    ...
    ("inputOption.activeBackground", "#ffffff22"),
    ("inputOption.activeBorder", "#007acc55"),
    ("inputOption.activeForeground", "@pure_white"),
    ...
    ("gitDecoration.deletedResourceForeground", "#e3b3b2"),
    ("gitDecoration.ignoredResourceForeground", "#627383"),
    ("gitDecoration.modifiedResourceForeground", "#ffd7ae"),
    ("gitDecoration.stageDeletedResourceForeground", "#e3b3b2"),
    ("gitDecoration.stageModifiedResourceForeground", "#ffd7ae"),
    ("gitDecoration.submoduleResourceForeground", "@bright_blue"),
    ("gitDecoration.untrackedResourceForeground", "#e4a1cd"),
    ...
    ("peekViewResult.fileForeground", "@pure_white"),
    ...
    ("peekViewTitleLabel.foreground", "@pure_white"),
    ...
    ("statusBarItem.offlineForeground", "@pure_white"),
...
def resolve_vscode_color(palette, ref):
...
def generate_vscode(palette, variant):
    ...
    for key, ref in VSCODE_UI_COLORS.items():
        colors[key] = resolve_vscode_color(p, ref)
    theme["colors"] = colors
